...
| 分支类型   | 命名格式          | 说明                                           |
| :--------- | :---------------- | :--------------------------------------------- |
| 主分支     | `main` / `master` | 生产代码所在分支，永远保持稳定和可发布状态       |
| 开发分支   | `develop`         | 用于集成开发的分支，所有新功能都在这里合并       |
| 功能分支   | `feature/<名称>`  | 每个新功能都有独立的分支                       |
| 修复分支   | `bugfix/<名称>`   | 用于修复功能 Bug                               |
| 发布分支   | `release/<版本>`  | 准备发布的代码，进行最后的测试和预发布           |
| 热修复分支 | `hotfix/<名称>`   | 紧急修复生产环境中的严重 Bug                   |
